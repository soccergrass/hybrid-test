...
async function handleSubmit(e){
    ...
    const sendMessage = {id: stamp + '-' + id, stamp, iden: isAuth, replied: false, replies: false, file: useFile ? useFile[0] : null, text: useText, category: isCategory, comment: document.getElementById('comment').value || null}

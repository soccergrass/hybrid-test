...
async function handleSubmit(e){
    ...
    const sendMessage = {id: stamp + '-' + MD5(useText || useFile[0]).toString(), stamp, replied: false, replies: false, iden: isAuth, file: useFile ? useFile[0] : null, text: useText, category: document.getElementById('category').value || null, comment: isComment}
